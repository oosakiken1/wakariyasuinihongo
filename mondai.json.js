...
'冗談（じょうだん）/好（す）きって言（い）っちゃったけど、あれ冗談（じょうだん）だから気にしないでってゆーか、そーゆーことだから。',
...
k1:[
'야마모토 씨는 반 대표로 뽑혔습니다.',
'3일 전부터 계속 비가 오고 있습니다.',
'아르바이트 면접은 다음 주 토요일입니다.',
'어려울 때 선생님이 도와주셨습니다.',
'푹 자서 기분이 좋습니다.',
'여기 컴퓨터는 누구나 쓸 수 있지만, 복사는 돈을 내야 합니다.',
'계속해서 새로운 게임이 나옵니다.',
'내일 비행기 예약을 확인해 주세요.',
'지금쯤 도쿄에는 벚꽃이 피어 있을 것입니다.',
'야마다 씨는 아이를 아주 예뻐합니다.',
]
}
