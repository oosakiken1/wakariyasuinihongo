...
s2:[
//original
'冗談（じょうだん）/昨日（きのう）、あんたなんか大（だい）っ嫌（きら）いって言（い）っちゃったけど、あれ、本気（ほんき）じゃないってゆーか、冗談（じょうだん）ってゆーか、そーゆーことだから。',
...
'残業（残業）する/締（し）め切（き）りに間（ま）に合（あ）わないので、デートは諦（あきら）めて今日（きょう）は残業（ざんぎょう）します。',
'ファミレス/サイゼリアは、ファミレスですか？はい、サイゼリアはファミレスです。',
'必（かなら）ずしも/イケメンだったとしても、必（かなら）ずしも彼女（かのじょ）がいるとはかぎらない。',
'ゴマをする/うちの課長（かちょう）は部下（ぶか）には厳（きび）しいのに、部長（ぶちょう）にはいつもゴマをすってばかりでさ。早（はや）く辞（や）めてくれないかな。',

'リストラ/ねえ、聞（き）いた？高橋（たかはし）さんのご主人（しゅじん）、この前（まえ）リストラされたらしいわよ。',
'ぐだぐだ/最近（さいきん）は、だらしなくグダグダすることを「グダる」というらしい。',
