...
s2:[
//original
'分別（ぶんべつ）/燃（も）えるゴミと燃（も）えないゴミを分別（ぶんべつ）する。',
'一気（いっき）に/もう朝（あさ）か。アニメがとても面白（おもしろ）かったので、最終話（さいしゅうわ）まで一気（いっき）に見（み）てしまった。',
'タイヤ/ボーナスが出（で）たので、バイクのタイヤを買（か）い替（か）えた。',
'真（ま）っ暗（くら）/今夜（こんや）は月（つき）が見（み）えないので、真（ま）っ暗（くら）な夜（よる）だ。',
...
'手作（てづく）り/買（か）ったものより手作（てづく）りのものの方（ほう）が、絶対（ぜったい）に気持（きもち）ちが伝（つた）わると思（おも）う。',
