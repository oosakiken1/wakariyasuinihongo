...
'さそいました/もりさんを　デートに　さそいましたが、行（い）けないと　言（い）われました。',
'センチ/わたしの　むすこは、１年（ねん）で　５センチくらい　せが　高（たか）く　なりました。',
'くらべる/お店（みせ）で　３だいの　パソコンを　くらべて、いちばん　かるい　パソコンを　えらびました。',
'るす/たなかさんの　いえの　電気（でんき）が　ついて　いませんね。たなかさんは　るすの　ようです。',
'見（み）つかる/へやの　かぎを　さがして　いますが、まだ　見（み）つかりません。',

'アルバイト/おとうさんは　あの　きっさてんで　アルバイトを　して　います。',
'すいえい/わたしは　すいえいが　すきです。',
'びっくりしする/それを　聞（き）いて　びっくりしました。',
...
'かざる/おきゃくさんが　来（き）ますから、へやに　花（はな）を　かざりましょう。',
