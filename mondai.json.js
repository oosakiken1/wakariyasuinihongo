...
'ゴマをする/うちの課長（かちょう）は部下（ぶか）には厳（きび）しいのに、部長（ぶちょう）にはいつもゴマをすってばかりで、いやになる。',
...
'ファミレス/サイゼリアは、ファミレスですか？はい、サイゼリアはファミレスです。',
...
'元日（がんじつ）/せっかく誘（さそ）ってもらったのにすみません。元日（がんじつ）は家族（かぞく）で初詣（はつもうで）に出掛（でか）けるつもりで、ごめんなさい。',
