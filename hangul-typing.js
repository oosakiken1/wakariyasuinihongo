...
BTN_START.onclick = function () {
    ...
    let tmpConfig = `ht-t:${config.time}-l:${config.level}-o:${config.order}-a:${config.audio}-p:${config.pass}`
    gtag('event', 'start-hangul-typing', {'event_category': 'execute', 'config': tmpConfig});
